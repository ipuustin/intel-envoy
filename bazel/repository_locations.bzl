...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_intel_qatlib = dict(
        ...
        version = "22.07.2",
        sha256 = "94f8be7efdf0d95a1bc781b4885cce162357cf5f9d1c997ccc4a3f9609c89fe4",
        # strip_prefix = "qatlib-{version}",
        urls = ["https://af01p-ir.devtools.intel.com/artifactory/scb-local/QAT_packages/QAT_U/QAT_UPSTREAM_23.02.0/QAT_UPSTREAM_23.02.0.L.0.0.0-00009/QAT_UPSTREAM_23.02.0.L.0.0.0-00009.tar.gz"],
        use_category = ["dataplane_ext"],
